...
/// `MossClient.session(_:options:)`. All embedding runs locally with
/// the session's model (`moss-minilm` unless `SessionOptions.modelId`
/// says otherwise); queries don't hit the network.
///
/// ```swift
