...
async def upload_documents():
    ...
    documents = [
        DocumentInfo(
            ...
            metadata={"category": "orders", "topic": "tracking"},
        ),
        DocumentInfo(
            id="doc-2",
        ...
        DocumentInfo(
            ...
            metadata={"category": "shipping", "topic": "address_change"},
        ),
        DocumentInfo(
            id="doc-4",
            ...
            metadata={"category": "shipping", "topic": "international"},
        ),
        DocumentInfo(
            id="doc-5",
        ...
        DocumentInfo(
            ...
            metadata={"category": "services", "topic": "gift_wrapping"},
        ),
        DocumentInfo(
            id="doc-10",
            ...
            metadata={"category": "pricing", "topic": "price_match"},
        ),
    ]
    ...
    try:
        ...
        await client.create_index(
            name=os.getenv("MOSS_INDEX_NAME", "product-knowledge"),
            docs=documents,
