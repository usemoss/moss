...
"""Pipecat Voice AI Bot with Ollama (local LLM) + Moss Semantic Retrieval.
...
print("Starting Ollama Local Voice AI Bot...")
logger.debug("All components loaded successfully!")

async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    """Run the voice bot pipeline with Ollama LLM."""

    # Initialize stt, tts, llm services
    logger.debug("Starting Ollama local voice bot")
...
async def bot(runner_args: RunnerArguments):
    """Main bot entry point for the Ollama local voice bot."""
